...
|---|---|---|
| `PlanPathAction` | `include/hint_behavior/nodes/plan_path_action.hpp` | `/path_planner/plan_path` |
| `FollowPathAction` | `include/hint_behavior/nodes/follow_path_action.hpp` | `/path_projector_node/follow_path` |
